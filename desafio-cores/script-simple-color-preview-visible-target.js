/**
 * 🎮 JOGO DE ADIVINHAÇÃO DE CORES - VERSÃO COM PREVIEW DE CORES E COR ALVO VISÍVEL
 ...
 * E COR SORTEADA CLARAMENTE VISÍVEL para o usuário
 */
...
function enableDebugMode() {
    ...
    debugInfo.innerHTML = `
        ...
        Cor digitada: <span id="debug-typed">-</span><br>
        Cor exibida: <span id="debug-displayed">-</span>
    `;
    ...
    setInterval(() => {
        ...
        document.getElementById('debug-displayed').textContent = gameState.targetColorDisplayed ? 'Sim' : 'Não';
    }, 500);
}

// Inicialização principal
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎮 Iniciando jogo de adivinhação de cores com cor alvo visível...');
    ...
    console.log('✅ Jogo de cores com cor alvo visível inicializado com sucesso!');
