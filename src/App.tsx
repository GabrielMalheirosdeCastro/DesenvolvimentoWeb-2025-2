    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          <h1 className="mb-4 text-indigo-800">
        ...
        <Card className="shadow-lg border-l-4 border-l-indigo-500">
          ...
          <CardContent>
            <p className="leading-relaxed text-gray-700">
              Meu nome é Gabriel Malheiros de Castro, sou uma
              pessoa com autismo e tenho problema de
              desmotivação e ansiedade, mas procuro fazer meu
              melhor.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg border-l-4 border-l-green-500">
          ...
          <CardContent className="space-y-4">
            <p className="leading-relaxed text-gray-700">
              Eu gosto de montar naves de lego de Star Wars e
              brincar um pouco mas também gosto de ver filmes e
              series de animação e de outras ficção cientifica.
            </p>
        ...
        <Card className="shadow-lg border-l-4 border-l-amber-500">
          ...
          <CardContent>
            <p className="leading-relaxed text-gray-700">
              Eu conhecia alguém que se achava perfeito por
              causa dessa afirmação falsa: "Todo mundo tem
              defeitos e fraquezas"; E ele disse: "eu não tenho
              nenhum defeito ou fraqueza."
            </p>
          </CardContent>
        </Card>

        {/* Sentimentos sobre Esforços */}
        <Card className="shadow-lg border-l-4 border-l-purple-500">
          ...
          <CardContent className="space-y-4">
            <p className="leading-relaxed text-gray-700">
              Eu sinto que meus esforços não são o bastante só
              por causa de quedas.
            </p>
            <div className="mt-4">
              <img
        ...
        <Card className="shadow-lg border-l-4 border-l-red-500">
          ...
          <CardContent className="space-y-4">
            <p className="leading-relaxed text-gray-700">
              Se você se acha tão esperto, descubra como a
              frase: "Eu sou muito saudável." com o uso da
              imagem de código morse.
            </p>
            <div className="mt-4">
              <img
                src={morseCodeImage}
